function varargout = MP_HA_5(varargin)
% MP_HA_5 M-file for MP_HA_5.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @MP_HA_5_OpeningFcn, ...
                   'gui_OutputFcn',  @MP_HA_5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MP_HA_5 is made visible.
function MP_HA_5_OpeningFcn(hObject, eventdata, handles, varargin)
clc;
cla reset;
...
% varargin   command line arguments to MP_HA_5 (see VARARGIN)

% Choose default command line output for MP_HA_5
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes MP_HA_5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = MP_HA_5_OutputFcn(hObject, eventdata, handles)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%I=imread('Earth-Western-Hemisphere.jpg');
global gg gc;
gc=0;
h=guidata(gcbo);
image_1 = h.image_1;
